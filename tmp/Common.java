...
//            System.out.println("**********************************************************************************______________");
    ...
    {
        long tmp = ( mybytes[0]) << 24 | ( mybytes[1]) << 16 | ( mybytes[2]) << 8
                | ( mybytes[3])  ;
        return tmp;
    ...
    {
        byte[]  a = "AEwBAAAHAAEAIAEiAAEAAAAEAAAAAgEAADQBAAEANAMAAgAENAUAAQA0BAAJQ3NxICBJcyA2NAIADDAwMDAwMDAwMDAzMgADAAJjuA==".getBytes();
