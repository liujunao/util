...
public class ReflectionUtils
{
	...
	public static Object getUpdateObject(Object po1, Object po2) {
		Class<? extends Object> ownerClass1 = po1.getClass();
		Class<? extends Object> ownerClass2 = po2.getClass(); 
		Object result = null;
		try {
			result = ownerClass2.newInstance();
		...
		for (Field field1 : ownerClass1.getDeclaredFields()) {
			field1.setAccessible(true);
			try {
				Object fieldValue1 = field1.get(po1);
				fieldValue1= null==fieldValue1?"":fieldValue1;
				for (Field field2 : ownerClass2.getDeclaredFields()) {
					field2.setAccessible(true);
					Object fieldValue2 = field2.get(po2);
					fieldValue2= null==fieldValue2?"":fieldValue2;
					if (field1.getName().trim().equals(field2.getName().trim())
							&& (!fieldValue1.toString().equals(
									fieldValue2.toString())||"id".equals(field1.getName()))) {
						 PropertyDescriptor pd = new PropertyDescriptor(field2.getName(), ownerClass2);
						 Method wM = pd.getWriteMethod();//获得写方法
						 wM.invoke(result, fieldValue2); 
					}
				}
			}
			catch (Exception e) {
